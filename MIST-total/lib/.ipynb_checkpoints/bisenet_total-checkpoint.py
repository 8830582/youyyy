#bisenetv3 model is integrate FFT and wavelet
...
#segment branch##########fuse1
        ...
        ##############fuse2##############
        feat3 = self.S3(feat2) #([1, 64, 32, 32]
        feat3 = self.FFT2(feat3)
        fuse2 = self.DWT2(d_feat2,feat3)
        fuse2 = self.dewconv2(fuse2)
        feat3 = fuse2 + feat3
        feat3 = self.br2(feat3)
        ##############fuse3##############
        feat4 = self.S4(feat3)
        feat4 = self.FFT3(feat4)
        fuse3 = self.DWT3(d_feat3,feat4)
        fuse3 = self.dewconv3(fuse3)
        feat4 = fuse3+feat4
        feat4 = self.br3(feat4)
        ##############others###############
        feat5_4 = self.S5_4(feat4)
