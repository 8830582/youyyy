# from lib.mobile import MobileNet
from lib.mobile import MobileNet
...
if __name__ == "__main__":
    model = mobile_UNet(n_channels=3,num_classes=5).cuda()
    ...
    # print(output.shape)
    # model = torchvision.models.segmentation.fcn_resnet50(pretrained=False, progress=True, num_classes=5)
