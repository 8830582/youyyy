...
class BiSeNetV1(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.aux_mode == 'train':
            ...
            return  feat_out16,feat_out32,feat_out
...
if __name__ == "__main__":
    net = BiSeNetV1(n_classes = 5, aux_mode='eval').cuda()
    net.eval()
    in_ten = torch.randn(2,1, 256, 256).cuda()
    ...
    # macs, params = get_model_complexity_info(net, (1,256,256), as_strings=True,print_per_layer_stat=False, verbose=True)
