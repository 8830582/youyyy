...
parser.add_argument('--volume_path', type=str,
                    default=r'', help='root dir for validation volume data')
...
parser.add_argument('--base_lr', type=float, default=0.00009,
...
if __name__ == "__main__":
    ...
    args.exp = 'MIST' + dataset_name + str(args.img_size)
    snapshot_path = "model_pth/{}/{}".format(args.exp, 'MIST')
    ...
    net = MIST_CAM(n_class=args.num_classes, img_size_s1=(args.img_size, args.img_size), img_size_s2=(224, 224),
                   model_scale='tiny', decoder_aggregation='additive', interpolation='bilinear').cuda()
