...
from lib.UNet_MobileNet import UNet

from trainer_distill import trainer_synapse
...
parser.add_argument('--root_path', type=str,
                    default=r'E:\data\Synapse\Synapse\train_npz', help='root dir for data')
parser.add_argument('--volume_path', type=str,
                    default=r'E:\data\Synapse\Synapse\test_vol_h5', help='root dir for validation volume data')
...
if __name__ == "__main__":
    ...
    #加载mobile_UNet网络
    mobile_net = UNet(n_channels=1, num_classes=4)
    print(f'Network:\n'+
    ...
    trainer[dataset_name](args,MISTnet,mobile_net,snapshot_path)#第一个是教师网络，第二个是学生网络
