...
if __name__ == "__main__":
    ...
    net = MIST_CAM(n_class=args.num_classes, img_size_s1=(args.img_size,args.img_size), img_size_s2=(224,224), model_scale='tiny', decoder_aggregation='additive', interpolation='bilinear')
