...
if __name__ == "__main__":
    ...
    args.exp = 'Chaos_seaformer' + dataset_name + str(args.img_size)
    snapshot_path = "model_pth/{}/{}".format(args.exp, 'Chaos_seaformer')
    ...
    MISTnet = MIST_CAM(n_class=args.num_classes, img_size_s1=(args.img_size,args.img_size), img_size_s2=(224,224), model_scale='small', decoder_aggregation='additive', interpolation='bilinear')
    ...
    macs, params = get_model_complexity_info(mobile_net, (3, args.img_size, args.img_size), as_strings=True,print_per_layer_stat=False, verbose=True)
    print('{:<30}  {:<8}'.format('Computational complexity: ', macs))
    print('{:<30}  {:<8}'.format('Number of parameters: ', params))

    trainer = {'Chaos': trainer_chaos, }
    trainer[dataset_name](args, MISTnet, snapshot_path)
